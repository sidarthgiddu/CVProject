...
short MAX_SPEED = 500; 
short MIN_SPEED = 0;
float ROBOT_HALF_WIDTH = 73.0; // in milimeters
...
void robotDriveCommands() {
  ...
  // pwm and use the sign of speed to decide FORWARD / BACKWARD
  ...
  pwmLeft = (byte)(1 - ROBOT_HALF_WIDTH / radius) * pwm;
  pwmRight = (byte)(1 + ROBOT_HALF_WIDTH / radius) * pwm;
